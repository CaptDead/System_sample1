...
$vtype=$_POST['vtype'];
$sql = "SELECT id from tblvehicles where (tblvehicles.VehiclesBrand=:brand and tblvehicles.FuelType=:fueltype) and tblvehicles.Vehicletype=:vtype";
...
$sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where (tblvehicles.VehiclesBrand=:brand and tblvehicles.FuelType=:fueltype ) and tblvehicles.Vehicletype=:vtype"; 
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':fueltype',$fueltype, PDO::PARAM_STR);
$query -> bindParam(':vtype',$vtype, PDO::PARAM_STR);
       ...
       <div class="product-listing-m" style="background-color: #C4C4C4; padding: 10px; border-radius: 5px;">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              ...
              <li>*<?php echo htmlentities($result->Vehicletype);?></li>
            </ul>
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn_view">View Details <span class="angle_arrow"></span></a>
          </div>
      </div>
      <?php }} ?>
         </div>
